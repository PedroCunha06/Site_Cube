...
function setFaceToWorldScale(worldToPixelScale) {
  ...
  faceShadowElem.style.setProperty(
    "--space_face",
    SPACE_CUBE * worldToPixelScale - 1
  );
  faceDownElem.style.setProperty(
    "--space_face",
    SPACE_CUBE * worldToPixelScale - 1
  );
  faceUpElem.style.setProperty(
    "--space_face",
    SPACE_CUBE * worldToPixelScale - 1
  );
}
...
function openBoxConfig() {
  if (boxConfigElem.style.display !== "none") {
    buttonElem.style.width = "70px";
    buttonElem.style.height = "70px";
